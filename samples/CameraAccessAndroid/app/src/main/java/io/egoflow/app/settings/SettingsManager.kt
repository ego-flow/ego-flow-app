...
object SettingsManager {
    ...
    // v0.0.1 intentionally exposes only RTMP and HTTP in the product UI. WHIP remains a
    // dormant experimental module until it has a selectable UI and real-glasses E2E evidence.
