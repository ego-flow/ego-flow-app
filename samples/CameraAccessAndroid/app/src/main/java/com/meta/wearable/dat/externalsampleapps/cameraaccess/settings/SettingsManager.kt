...
object SettingsManager {
    ...
    var rtmpEnabled: Boolean
        get() = prefs.getBoolean("rtmpEnabled", Secrets.rtmpEnabled)
        set(value) = prefs.edit().putBoolean("rtmpEnabled", value).apply()

    var rtmpPublishUrl: String
        get() = prefs.getString("rtmpPublishUrl", null) ?: Secrets.rtmpPublishUrl
        set(value) = prefs.edit().putString("rtmpPublishUrl", value).apply()
