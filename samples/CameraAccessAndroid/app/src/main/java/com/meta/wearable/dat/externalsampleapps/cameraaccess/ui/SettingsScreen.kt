...
fun SettingsScreen(
    ...
    var rtmpPublishUrl by remember { mutableStateOf(SettingsManager.rtmpPublishUrl) }
    ...
    fun save() {
        ...
        SettingsManager.rtmpEnabled = rtmpEnabled
        SettingsManager.rtmpPublishUrl = rtmpPublishUrl.trim()
        SettingsManager.rtmpDebugOverlayEnabled = rtmpDebugOverlayEnabled
    }
    ...
    fun reload() {
        ...
        rtmpPublishUrl = SettingsManager.rtmpPublishUrl
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Text(
                text = "Use a LAN URL like http://192.168.0.10 or an HTTPS tunnel like https://abc123.ngrok-free.app.",
            ...
            MonoTextField(
                ...
                label = "Hook Token",
                placeholder = "Optional unless you expose /hooks/*",
            )
            MonoTextField(
            ...
            SectionHeader("RTMP Publish")
            SettingToggleRow(
                label = "Enable RTMP publishing",
                checked = rtmpEnabled,
                onCheckedChange = { rtmpEnabled = it },
            )
            MonoTextField(
                value = rtmpPublishUrl,
                onValueChange = { rtmpPublishUrl = it },
                label = "Publish URL",
                placeholder = "rtmp://192.168.0.10:1935/live/glasses",
                keyboardType = KeyboardType.Uri,
            )
            SettingToggleRow(
                label = "Show RTMP debug overlay",
                checked = rtmpDebugOverlayEnabled,
                onCheckedChange = { rtmpDebugOverlayEnabled = it },
            )
